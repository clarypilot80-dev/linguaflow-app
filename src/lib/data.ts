...
export const COLLECTIONS: Collection[] = [
  {
    id: 'core-verbs-engine',
    name: 'The Engine',
    subtitle: 'Collection 1 — Core Verbs (Present Tense)',
    description: 'The foundation of all movement and state in French. Master Faire, Aller, Avoir, and Être to unlock basic conversational autonomy.',
    icon: '⚙️',
    color: '#6366f1',
    accentColor: '#818cf8',
    dialogues: [
      {
        id: 'dial-action',
        title: 'Action (Faire / Aller)',
        description: 'Expressing movement, plans, and actions happening right now.',
        icon: '🏃',
        sentences: [
          makeSentence('cv1', 1, "Je vais faire ça.", "I'm going to do that.", "zhuh vay fair sah"),
          makeSentence('cv2', 2, "Tu vas où ?", "Where are you going?", "too vah oo"),
          makeSentence('cv3', 3, "Qu'est-ce que tu fais ?", "What are you doing?", "kes-kuh too fay"),
          makeSentence('cv4', 4, "Je vais voir.", "I'm going to see. / I'll see.", "zhuh vay vwar"),
          makeSentence('cv5', 5, "Il fait quoi ?", "What's he doing?", "eel fay kwah"),
        ],
      },
      {
        id: 'dial-state',
        title: 'Possession & State (Avoir / Être)',
        description: 'Defining existence, states of being, and ownership.',
        icon: '🧘',
        sentences: [
          makeSentence('cs1', 1, "C'est pas prêt.", "It's not ready.", "say pah pray"),
          makeSentence('cs2', 2, "J'ai pas le temps.", "I don't have time.", "zhay pah luh ton"),
          makeSentence('cs3', 3, "Tu es où ?", "Where are you?", "too ay oo"),
          makeSentence('cs4', 4, "J'ai faim.", "I'm hungry.", "zhay fan"),
          makeSentence('cs5', 5, "C'est à moi.", "It's mine.", "say ah mwah"),
        ],
      },
    ],
  },
  {
    id: 'modal-framing',
    name: 'Intent & Obligation',
    subtitle: 'Collection 2 — Modal Framing',
    description: 'Wrap your core verbs in human intent: desire, capability, and necessity using Vouloir, Pouvoir, and Devoir.',
    icon: '🎯',
    color: '#ec4899',
    accentColor: '#f472b6',
    dialogues: [
